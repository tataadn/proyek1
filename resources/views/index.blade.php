		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Akun Profile</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        <li><a href="" target="_blank">Absensi</a></li>
					        <li><a href="" target="_blank">Riwayat Absensi</a></li>
					    </ul>
					</li>
				</ul>
			</div>
