...
<body class="">
		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="{{ route('siswa.dashboard') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
					</li>
					<li class="nav-item">
					    <a href="{{ url('siswa/profile') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Akun Profile</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        <li><a href="{{ url('siswa/absensi') }}">Absensi</a></li>
					        <li><a href="{{ url('siswa/history') }}">Riwayat Absensi</a></li>
					    </ul>
					</li>
				</ul>
			</div>
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
				<div class="m-header">
					...
					<a href="{{ route('siswa.dashboard') }}" class="b-brand">
